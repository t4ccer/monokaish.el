...
(autothemer-deftheme
 ...
 ((default             (:foreground monokaish-white :background monokaish-black))
  ...
  (ansi-color-cyan (:foreground monokaish-blue))
  (ansi-color-blue (:foreground monokaish-blue))
  (ansi-color-magenta (:foreground monokaish-purple))
  (ansi-color-red (:foreground monokaish-red))
  (ansi-color-yellow (:foreground monokaish-orange))
  (ansi-color-green (:foreground monokaish-green))
  (ansi-color-black (:foreground monokaish-black))
  (ansi-color-white (:foreground monokaish-white))
  (ansi-color-bright-cyan (:foreground monokaish-blue))
  (ansi-color-bright-blue (:foreground monokaish-blue))
  (ansi-color-bright-magenta (:foreground monokaish-purple))
  (ansi-color-bright-red (:foreground monokaish-red))
  (ansi-color-bright-yellow (:foreground monokaish-yellow))
  (ansi-color-bright-green (:foreground monokaish-green))
  (ansi-color-bright-black (:foreground monokaish-black))
  (ansi-color-bright-white (:foreground monokaish-white))
  (ansi-color-faint (:foreground monokaish-gray))
